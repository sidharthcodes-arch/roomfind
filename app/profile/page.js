...
import {
  User, Phone, Mail, Home, MapPin, Trash2, LogOut, Loader2, Plus
} from 'lucide-react'
...
function ListingItem({ listing, onDelete }) {
  ...
  return (
    <div className="flex gap-3 items-start p-3 bg-white rounded-xl border border-slate-100">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-slate-400 text-xs mt-0.5">{listing.area}, {listing.city}</p>
        <span className={`inline-block mt-1 text-xs px-1.5 py-0.5 rounded-full ${
          listing.is_available ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
        }`}>
    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-100">
          {profileLoading ? (
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center shrink-0 overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            {listingsLoading ? (
              ...
              <div className="bg-white rounded-2xl p-6 border border-dashed border-slate-200 text-center">
                ...
                <Link
                  href="/create-listing"
                  className="mt-2 inline-block text-amber-600 text-sm font-medium underline underline-offset-2"
                >
        ...
        <button
          ...
          disabled={signingOut}
          className="w-full flex items-center justify-center gap-2 py-2.5 border border-red-200 text-red-600 rounded-xl text-sm font-medium hover:bg-red-50 transition-colors disabled:opacity-50"
        >
          {signingOut ? (
